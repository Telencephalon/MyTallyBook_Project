...
- [项目功能目录、MySQL / Nginx 目录与7631端口更换指南](docs/28-项目功能目录与7631端口更换指南.md)
- [小程序逐文件职责](docs/目录说明/小程序目录与文件职责.md)
- [后端逐文件职责](docs/目录说明/后端目录与文件职责.md)
- [实际服务器部署、微信审核发布与后续升级手册](docs/26-备案完成后首次服务器迁移与小程序发布手册.md)
